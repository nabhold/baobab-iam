...
**Status:** Phase 1 complete. Phase 2a (`baobab-trade` OIDC wiring) complete — `nabhold/baobab-trade#70`. Phase 2b (`baobab-cms` OIDC wiring) is now also complete — `nabhold/baobab-cms#9` — see §5.1 for what it built and what it deliberately still leaves open. Remaining phases (admin role model in `baobab-cp`, MFA/step-up, lifecycle, audit) are scoped below but not yet implemented — see §5.
**Date:** 2026-09-12
